...
<div class="wrapper row2">
  <div id="container" class="clear">
    ...
    <section id="slider" class="clear">
      <figure><img src="<?php echo get_template_directory_uri(); ?>/images/demo/630x300.gif" alt="">
        <figcaption>
    ...
    <div id="intro">
      <section class="clear">
        ...
        <article class="two_quarter lastbox">
          <figure>
            <ul class="clear">
              <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/demo/130x130.gif" width="130" height="130" alt=""></a></li>
              <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/demo/130x130.gif" width="130" height="130" alt=""></a></li>
              <li class="last"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/demo/130x130.gif" width="130" height="130" alt=""></a></li>
            </ul>
    ...
    <div id="homepage" class="last clear">
      ...
      <section class="two_quarter lastbox">
        ...
        <img class="imgl" src="<?php echo get_template_directory_uri(); ?>/images/demo/130x130.gif" width="130" height="130" alt="">
