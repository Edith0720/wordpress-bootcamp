 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('SECURE_AUTH_KEY', 'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('LOGGED_IN_KEY', 'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('NONCE_KEY', 'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('AUTH_SALT',        'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('SECURE_AUTH_SALT', 'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('LOGGED_IN_SALT',   'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
define('NONCE_SALT',       'dfthdfgbhhdbhdhdfbgdfsgdghjfgjmnfnghdfdbndbgt');
